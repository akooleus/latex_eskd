...
% Для длинной темы можно переопределить многострочное оформление титульника:
% \newcommand{\ProjectThemeTitle}{%
% \AmpThemeLine{Первая строка темы}\\[4pt]
% \AmpThemeLine{Вторая строка темы}%
% }
